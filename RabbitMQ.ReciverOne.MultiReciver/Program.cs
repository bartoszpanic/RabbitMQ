...
Console.Title = "Rabbit MQ - czym jest kolejka? - Odbiorca Pierwszy";
...
var queueName = await channel.QueueDeclareAsync(queue: "RabbitMQ.MultiReciver1", durable: true, exclusive: false, autoDelete: false, arguments: null);

await channel.BasicQosAsync(prefetchSize: 0, prefetchCount: 1, global: false);

await channel.QueueBindAsync(queue: queueName, exchange: "RabbitMQ.MultiReciver", routingKey: "");
...
channel.BasicConsumeAsync(queue: "RabbitMQ.MultiReciver1", autoAck: false, consumer: consumer);
