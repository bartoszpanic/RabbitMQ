...
Console.Title = "Rabbit MQ - czym jest kolejka? - Odbiorca Drugi";
...
var queueName = await channel.QueueDeclareAsync(queue: "RabbitMQ.MultiReciver2", durable: true, exclusive: false, autoDelete: false, arguments: null);
...
channel.BasicConsumeAsync(queue: "RabbitMQ.MultiReciver2", autoAck: false, consumer: consumer);
